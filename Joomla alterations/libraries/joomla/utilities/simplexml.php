...
class JSimpleXML extends JObject
{
	...
	*/
	 ...
	 */
	function _handleError($code, $line, $col, $path)
	{
		JError::raiseWarning( 'SOME_ERROR_CODE' , 'XML Parsing Error in "'.htmlspecialchars($path).'" at '.$line.':'.$col.'. Error '.$code.': '.xml_error_string($code));
	}
