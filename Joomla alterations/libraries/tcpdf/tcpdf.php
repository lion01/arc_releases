...
if (!class_exists('TCPDF')) {
	 ...
	 */ 
	define('PDF_PRODUCER','TCPDF 4.3.005_PHP4 (http://www.tcpdf.org)');
	...
	*/
	class TCPDF {
		...
		* @since 1.5
		*/
		function Write($h, $txt, $link='', $fill=0, $align='', $ln=false, $stretch=0, $firstline=false, $firstblock=false) {
