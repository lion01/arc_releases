...
<div class="col50">
	<fieldset class="adminform">
		...
		<tr>
			...
			<td>
				<?php echo JHTML::_('select.genericList', $this->meanings['school'], 'schMeaning', '', 'id', 'school_meaning', $this->item->school_meaning_id ); ?>
			</td>
		</tr>
		<tr>
			<td width="100" align="right" class="key">
			...
			<td>
				<?php echo JHTML::_('select.genericList', $this->meanings['statistical'], 'statMeaning', '', 'id', 'statistical_meaning', $this->item->statistical_meaning_id ); ?>
			</td>
		</tr>
		<tr>
			<td width="100" align="right" class="key">
			...
			<td>
				<?php echo JHTML::_('select.genericList', $this->meanings['physical'], 'physMeaning', '', 'id', 'physical_meaning', $this->item->physical_meaning_id ); ?>
			</td>
		</tr>
		<tr>
			<td width="100" align="right" class="key">
		...
		<tr>
			...
			<td>
				<input class="text_area" type="text" name="image_link" id="image_link" size="32" maxlength="250" value="<?php echo $this->item->image_link;?>" />
			</td>
		</tr>
		<tr>
			<td width="100" align="right" class="key">
			...
			<td>
				<input class="text_area" type="text" name="type" id="type" size="32" maxlength="25" value="<?php echo $this->item->type;?>" />
			</td>
		</tr>
				<tr>
			<td width="100" align="right" class="key">
			...
			<td>
				<input class="text_area" type="text" name="order_id" id="order_id" size="10" maxlength="3" value="<?php echo $this->item->order_id;?>" />
			</td>
		</tr>
	</table>
	</fieldset>
