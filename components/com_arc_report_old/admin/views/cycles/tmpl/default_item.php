...
<tr class="<?php echo 'row'.$this->item->index % 2; ?>">
	...
	<td>
		<?php echo $this->item->year_group; ?>
	</td>
	<td>
		<?php echo $this->item->valid_from; ?>
	</td>
	<td>
		<?php echo $this->item->valid_to; ?>
	</td>
	<td>
		<?php $message = ( $this->item->allow_multiple == "1" ) ? "Yes" : "No"; echo $message; ?>
	</td>
	<td>
		<?php echo $this->item->rechecker; ?>
	</td>
</tr>