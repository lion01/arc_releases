 ...
 * @since 0.1
 */
class ApothReportStandard_Coursework extends ApothReport
{
	/**
	...
	function init( $student, $group )
	{
		...
		$this->_fields['setname']     = new ApothFieldWord   ( $this, 'setname',     '',        36, 126,  59, 138, 0.5, 0, 0.5, 0.5,  '25%', '1.5em', 'Teaching Set:',  $this->_data2->group_name, '');
		$this->_fields['attitude']    = new ApothFieldLookup ( $this, 'attitude',    '',        59, 126,  82, 138, 1, 1, 0.5, 0.5,  '25%', '1.5em', 'Attitude:',      $student, $group );
		$this->_fields['clp']         = new ApothFieldLookup ( $this, 'clp',         '',        82, 126, 105, 138, 1, 1, 0.5, 0.5,  '25%', '1.5em', 'CLP:',           $student, $group );
		$this->_fields['cwork']       = new ApothFieldLookup ( $this, 'coursework',  '',       105, 126, 130, 138, 0.5, 0.5, 0.5, 0.5,  '25%', '1.5em', 'Coursework:',    $student, $group );
		$this->_fields['exam']        = new ApothFieldLookup ( $this, 'exam',        '',       130, 126, 153, 138, 1, 1, 0.5, 0.5,  '25%', '1.5em', 'Exam:',    $student, $group );
		$this->_fields['target']      = new ApothFieldLookup ( $this, 'target',      '',       153, 126, 174, 138, 1, 1, 0.5, 0.5,  '25%', '1.5em', 'Target:',  $student, $group );
		$this->_fields['ontarget']    = new ApothFieldBool   ( $this, 'ontarget',    'flag_1', 174, 126, 198, 138, 1, 1, 0.5, 0.5,  '25%', '1.5em', 'On Target?',     $this->_data->flag_1, '');
		...
		$lists = array('attitude', 'clp', 'target');
		foreach($banked as $b) {
		...
		$this->_layout[5][] = &$this->_fields['cwork'];
