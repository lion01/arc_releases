 ...
 * @since 0.1
 */
class ApothReportCsi extends ApothReport
{
	/**
	...
	function init( $student, $group )
	{
		...
		$this->_fields['description'] = new ApothFieldText   ( $this, 'description', 'blurb_1', 36,  84, 198, 121, 1, 1, 0.5, 0.5, '100%',   '8em', 'Course Description:',      $this->_style->blurb_1, '');
		$this->_fields['coursework']  = new ApothFieldText   ( $this, 'coursework',  'blurb_2', 36,  84, 198, 121, 1, 1, 0.5, 0.5, '100%',   '8em', 'Coursework Description:',  $this->_style->blurb_2, '');
		$this->_fields['set']         = new ApothFieldHidden ( $this, 'set',         'group',    0,   0,   0,   0, 1, 1, 0.5, 0.5,  '0%', '1.5em', '',               $this->_data->group, '');
		$this->_fields['setname']     = new ApothFieldWord   ( $this, 'setname',     '',        36, 121, 68, 138, 1, 1, 0.5, 0.5,  '30%', '1.5em', 'Teaching Set:',  $this->_data2->group_name, '');
		$this->_fields['attitude']    = new ApothFieldLookup ( $this, 'attitude',    '',      68, 121, 90, 138, 1, 1, 0.5, 0.5,  '30%', '1.5em', 'Attitude:',      $student, $group );
		$this->_fields['clp1']        = new ApothFieldLookup ( $this, 'clp1',        '',      90, 121, 130, 138, 1, 1, 0.5, 0.5,  '30%', '1.5em', 'CLP Knowledge & Understanding:', $student, $group );
		$this->_fields['clp2']        = new ApothFieldLookup ( $this, 'clp2',        '',       130, 121, 162, 138, 1, 1, 0.5, 0.5,  '50%', '1.5em', 'CLP Collaboration:',            $student, $group );
		$this->_fields['clp3']        = new ApothFieldLookup ( $this, 'clp3',        '',       162, 121, 198, 138, 1, 1, 0.5, 0.5,  '50%', '1.5em', 'CLP Communication:',            $student, $group );
