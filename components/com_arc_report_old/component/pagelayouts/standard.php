 ...
 * @since 0.1
 */
class ApothReportStandard extends ApothReport
{
	/**
	...
	function init( $student, $group )
	{
		...
		$this->_fields['attitude']    = new ApothFieldLookup ( $this, 'attitude',    '',        63, 126,  90, 138, 1, 1, 0.5, 0.5,  '30%', '1.5em', 'Attitude:',      $student, $group );
		$this->_fields['clp']         = new ApothFieldLookup ( $this, 'clp',         '',        90, 126, 116, 138, 1, 1, 0.5, 0.5,  '30%', '1.5em', 'CLP:',           $student, $group );
		$this->_fields['exam']        = new ApothFieldLookup ( $this, 'exam',        '',       116, 126, 144, 138, 1, 1, 0.5, 0.5,  '30%', '1.5em', 'Exam Grade:',    $student, $group );
		$this->_fields['target']      = new ApothFieldLookup ( $this, 'target',      '',       144, 126, 170, 138, 0.25, 0, 0.5, 0.5,  '30%', '1.5em', 'Target Grade:',  $student, $group );
