 ...
 * @since 0.1
 */
class ApothReportStandard_Basic extends ApothReport
{
	/**
	...
	function init( $student, $group )
	{
		...
		$this->_fields['setname']     = new ApothFieldWord   ( $this, 'setname',     '',        36, 126,  63, 138, 0.5, 0, 0.5, 0.5,  '30%', '1.5em', 'Teaching Set:', $this->_data2->group_name, '');
		$this->_fields['attitude']    = new ApothFieldList   ( $this, 'attitude',    'stat_1',  63, 126,  90, 138, 1, 1, 0.5, 0.5,  '30%', '1.5em', 'Attitude:',     $this->_data->stat_1, '', $this->_style->mark_style);
		$this->_fields['clp']         = new ApothFieldList   ( $this, 'clp',         'stat_2',  90, 126, 116, 138, 1, 1, 0.5, 0.5,  '30%', '1.5em', 'CLP:',          $this->_data->stat_2, '', $this->_style->mark_style);
		$this->_fields['exam']        = new ApothFieldList   ( $this, 'exam',        'stat_3', 116, 126, 144, 138, 1, 1, 0.5, 0.5,  '30%', '1.5em', 'Exam Grade:',   $this->_data->stat_3, '', $this->_style->mark_style);
		$this->_fields['target']      = new ApothFieldList   ( $this, 'target',      'stat_4', 144, 126, 170, 138, 0.25, 0, 0.5, 0.5,  '30%', '1.5em', 'Target Grade:', $this->_data->stat_4, '', $this->_style->mark_style);
		$this->_fields['ontarget']    = new ApothFieldBool   ( $this, 'ontarget',    'flag_1', 170, 126, 198, 138, 1, 1, 0.5, 0.5,  '30%', '1.5em', 'On Target?',   $this->_data->flag_1, '');
