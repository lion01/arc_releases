 ...
 * @since 0.1
 */
class ApothReportStandard_No_Ontarget extends ApothReport
{
	/**
	...
	function init( $student, $group )
	{
		...
		$this->_fields['exam']        = new ApothFieldLookup ( $this, 'exam',        '',       135, 126, 168, 138, 1, 1, 0.5, 0.5,  '50%', '1.5em', 'Exam Grade:',    $student, $group );
		$this->_fields['target']      = new ApothFieldLookup ( $this, 'target',      '',       168, 126, 198, 138, 1, 1, 0.5, 0.5,  '50%', '1.5em', 'Target Grade:',  $student, $group );
