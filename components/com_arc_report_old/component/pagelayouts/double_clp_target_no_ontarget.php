 ...
 * @since 0.1
 */
class ApothReportDouble_clp_target_no_ontarget extends ApothReport
{
	/**
	...
	function init( $student, $group )
	{
		...
		$this->_fields['setname']     = new ApothFieldWord   ( $this, 'setname',     '',        36, 126,  69, 138, 0.5, 0, 0.5, 0.5,  '17%', '1.5em', 'Teaching Set:', $this->_data2->group_name, '');
		$this->_fields['attitude']    = new ApothFieldLookup ( $this, 'attitude',    'stat_1',  69, 126, 102, 138, 1, 1, 0.5, 0.5,  '17%', '1.5em', 'Attitude:',  $student, $group);
		$this->_fields['clp']         = new ApothFieldFixed  ( $this, 'clp',         '',       102, 126, 150, 138, 1, 1, 0.5, 0.5,  '15%', '1.5em', 'CLP:',       '', '', '');
		$this->_fields['clp1']        = new ApothFieldLookup ( $this, 'clp1',        'stat_2', 102, 132, 126, 138, 1, 1, 0.5, 0.5,  '17%', '1.5em', '',           $student, $group);
		$this->_fields['clp2']        = new ApothFieldLookup ( $this, 'clp2',        'stat_5', 126, 132, 150, 138, 1, 1, 0.5, 0.5,  '17%', '1.5em', '',           $student, $group);
		$this->_fields['target']      = new ApothFieldFixed  ( $this, 'target',      '',       150, 126, 198, 138, 0.25, 0, 0.5, 0.5,  '15%', '1.5em', 'Target Grade:', '', '', '');
		$this->_fields['target1']     = new ApothFieldLookup ( $this, 'target1',     'stat_4', 150, 132, 174, 138, 1, 1, 0.5, 0.5,  '17%', '1.5em', '',           $student, $group);
		$this->_fields['target2']     = new ApothFieldLookup ( $this, 'target2',     'stat_6', 174, 132, 198, 138, 1, 1, 0.5, 0.5,  '17%', '1.5em', '',           $student, $group);
		...
		$this->_fields['clp1']->showTitle           = false;
		$this->_fields['clp2']->showTitle           = false;
		$this->_fields['target1']->showTitle        = false;
		$this->_fields['target2']->showTitle        = false;
		...
		$this->_fields['clp1']->titleClearance        = 0;
		$this->_fields['clp2']->titleClearance        = 0;
		$this->_fields['target1']->titleClearance     = 0;
		$this->_fields['target2']->titleClearance     = 0;
