 ...
 * @since 0.1
 */
class ApothReportStandard_No_Exam extends ApothReport
{
	/**
	...
	function init( $student, $group )
	{
		...
		$this->_fields['setname']     = new ApothFieldWord   ( $this, 'setname',     '',        36, 126,  69, 138, 1, 1, 0.5, 0.5,  '30%', '1.5em', 'Teaching Set:',  $this->_data2->group_name, '');
		$this->_fields['attitude']    = new ApothFieldLookup ( $this, 'attitude',    '',        69, 126, 102, 138, 1, 1, 0.5, 0.5,  '30%', '1.5em', 'Attitude:',      $student, $group );
		$this->_fields['clp']         = new ApothFieldLookup ( $this, 'clp',         '',       102, 126, 135, 138, 1, 1, 0.5, 0.5,  '30%', '1.5em', 'CLP:',           $student, $group );
		$this->_fields['target']      = new ApothFieldLookup ( $this, 'target',      '',       135, 126, 168, 138, 1, 1, 0.5, 0.5,  '50%', '1.5em', 'Target Grade:',  $student, $group );
		$this->_fields['ontarget']    = new ApothFieldBool   ( $this, 'ontarget',    'flag_1', 168, 126, 198, 138, 1, 1, 0.5, 0.5,  '50%', '1.5em', 'On Target?',     $this->_data->flag_1, '');
