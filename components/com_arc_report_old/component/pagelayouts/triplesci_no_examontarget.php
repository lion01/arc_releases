 ...
 * @since 0.1
 */
class ApothReportTripleSci_No_ExamOntarget extends ApothReport
{
	/**
	...
	function init( $student, $group )
	{
		...
		$this->_fields['setname']     = new ApothFieldWord   ( $this, 'setname',     '',        36, 126,  76, 138, 1, 1, 0.5, 0.5,  '30%', '1.5em', 'Teaching Set:',  $this->_data2->group_name, '');
		$this->_fields['attitude']    = new ApothFieldLookup ( $this, 'attitude',    '',        76, 126, 116, 138, 1, 1, 0.5, 0.5,  '30%', '1.5em', 'Attitude:',      $student, $group );
		$this->_fields['clp']         = new ApothFieldFixed  ( $this, 'clp',         '',       116, 126, 157, 138, 1, 1, 0.5, 0.5,  '25%', '1.5em', 'CLP:',           '', '', '');
		$this->_fields['clp1']        = new ApothFieldLookup ( $this, 'clp1',        '',       116, 132, 130, 143, 1, 1, 0.5, 0.5,  '25%', '1.5em', 'Bio',            $student, $group );
		$this->_fields['clp2']        = new ApothFieldLookup ( $this, 'clp2',        '',       130, 132, 143, 143, 1, 1, 0.5, 0.5,  '25%', '1.5em', 'Che',            $student, $group );
		$this->_fields['clp3']        = new ApothFieldLookup ( $this, 'clp3',        '',       143, 132, 157, 143, 1, 1, 0.5, 0.5,  '25%', '1.5em', 'Phy',            $student, $group );
		$this->_fields['target']      = new ApothFieldFixed  ( $this, 'target',      '',       157, 126, 198, 138, 1, 1, 0.5, 0.5,  '25%', '1.5em', 'Target Grade:',  '', '', '' );
		$this->_fields['target1']     = new ApothFieldLookup ( $this, 'target1',     '',       157, 132, 171, 143, 1, 1, 0.5, 0.5,  '25%', '1.5em', 'Bio:',           $student, $group );
		$this->_fields['target2']     = new ApothFieldLookup ( $this, 'target2',     '',       171, 132, 184, 143, 1, 1, 0.5, 0.5,  '25%', '1.5em', 'Che:',           $student, $group );
		$this->_fields['target3']     = new ApothFieldLookup ( $this, 'target3',     '',       184, 132, 198, 143, 1, 1, 0.5, 0.5,  '25%', '1.5em', 'Phy:',           $student, $group );
		...
		$this->_layout[5][] = &$this->_fields['clp'];
		$this->_layout[5][] = &$this->_fields['clp1'];
		$this->_layout[5][] = &$this->_fields['clp2'];
		$this->_layout[5][] = &$this->_fields['clp3'];
		$this->_layout[6][] = &$this->_fields['target'];
		$this->_layout[6][] = &$this->_fields['target1'];
		$this->_layout[6][] = &$this->_fields['target2'];
		$this->_layout[6][] = &$this->_fields['target3'];
		$this->_layout[7][] = &$this->_fields['current_txt'];
		$this->_layout[8][] = &$this->_fields['targets'];
		$this->_layout[9][] = &$this->_fields['method'];
		$this->_layout[10][] = &$this->_fields['author'];
		$this->_layout[10][] = &$this->_fields['date'];
