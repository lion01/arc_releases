 ...
 * @since      1.6
 */
class TvAdminControllerDatabase extends TVAdminController
{
	/**
	 * Default method
	 */
	...
	/**
	 * Save changes to video database parameters
	 */
	function save()
	{
		global $mainframe;
		...
		// Retrieve data for video database configuration
